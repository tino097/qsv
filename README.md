...
[![Minimum supported Rust version](https://img.shields.io/badge/Rust-1.85.0-red?logo=rust)](#minimum-supported-rust-version)
...
🐻‍❄️: command powered by [![polars 0.46.0](https://img.shields.io/badge/polars-0.46.0-blue) at the py-1.23.0 tag](https://github.com/pola-rs/polars/releases/tag/py-1.23.0).  
